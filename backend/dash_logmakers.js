...
const MONDAY_BOARD_ID = "18027717616"; // Alterar conforme necessário
const TABLE_NAME = "dash_logmakers"; // Nome da tabela
...
export default async function dashLogmakers() {
